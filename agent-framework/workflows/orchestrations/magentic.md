...
Execute a complex task and handle events for streaming output and orchestration updates. The terminal output is an `AgentResponse` containing the manager's synthesized final answer:

...
This approach is consistent with how MCP Apps works with all other AG-UI integrations — the MCP Apps layer is always in the TypeScript middleware, not in the .NET backend.

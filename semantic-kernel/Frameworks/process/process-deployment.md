...
> [!NOTE]
> Dapr will be supported first with the .NET Process Framework, followed by Orleans in the upcoming release of the Python version of the Process Framework.

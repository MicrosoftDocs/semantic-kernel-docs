...
The `08-Native-Functions-with-Context` console application shows the final solution to the [Using multiple inputs in native functions](https://learn.microsoft.com/en-us/semantic-kernel/ai-orchestration/plugins/native-functions/multiple-parameters) doc article.
...
```powershell
cd 08-Native-Functions-with-Context

...
The `06-Calling-Nested-Functions-In-Semantic-Functions` console application shows the final solution to the [calling functions in semantic functions](https://learn.microsoft.com/en-us/semantic-kernel/ai-orchestration/semantic-functions/calling-nested-functions) doc article.

...
This console application demonstrates the final solution to the [inline prompts](https://learn.microsoft.com/en-us/semantic-kernel/agents/plugins/semantic-functions/inline-semantic-functions) doc article.

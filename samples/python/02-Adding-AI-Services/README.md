...
This console application demonstrates the final solution to the [adding AI services](https://learn.microsoft.com/en-us/semantic-kernel/creating-agents/kernel/adding-services) doc article.

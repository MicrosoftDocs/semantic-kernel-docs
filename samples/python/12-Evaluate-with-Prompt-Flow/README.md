...
This console application demonstrates the final solution to the [creating prompt flow](https://learn.microsoft.com/en-us/semantic-kernel/creating-agents/planners/evaluate-and-deploy-planners/create-a-prompt-flow-with-semantic-kernel) doc article.

...
This console application demonstrates the final solution to the [Run native code with Semantic Kernel](https://learn.microsoft.com/en-us/semantic-kernel/agents/plugins/native-functions/using-the-skfunction-decorator) doc article.

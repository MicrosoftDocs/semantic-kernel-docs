...
This console application demonstrates the final solution to the [Chaining functions together](https://learn.microsoft.com/en-us/semantic-kernel/agents/chaining-functions) doc article.

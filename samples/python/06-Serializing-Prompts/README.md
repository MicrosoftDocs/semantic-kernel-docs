...
This console application demonstrates the final solution to the [serializing prompts](https://learn.microsoft.com/en-us/semantic-kernel/agents/plugins/semantic-functions/serializing-semantic-functions) doc article.

...
This console application demonstrates the final solution to the [calling functions in prompts](https://learn.microsoft.com/en-us/semantic-kernel/agents/semantic-functions/calling-nested-functions) doc article.
